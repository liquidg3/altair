  ...
  module.exports = Repo = (function() {
    ...
    Repo.prototype.diff = function(commitA, commitB) {
      ...
      if (arguments.length === 3) {
        ...
        _ref2 = arguments.slice(2), paths = _ref2[0], options = _ref2[1], callback = _ref2[2];
      }
    ...
    Repo.prototype.remote_push = function(name, callback) {
      return this.git("push", {}, name, function(err, stdout, stderr) {
        return callback(err);
      });
    };
    ...
    Repo.prototype.sync = function(remote_name, branch_name, callback) {
      ...
      return this.status(function(err, status) {
        ...
        return _this.git("stash", {}, ["save", "-u"], function(err) {
          if (err) {
            return callback(err);
          }
          return _this.git("pull", {}, [remote, branch], function(err) {
            if (err) {
              return callback(err);
            }
            return _this.git("push", {}, [remote, branch], function(err) {
              if (err) {
                return callback(err);
              }
